...
Route::prefix('user-disposisi')
    ...
    ->group(function () {
        ...
        Route::get('allow-notifikasi', [PengaturanController::class, 'allownotif'])->name('allownotif');
        Route::post('allow-notifikasi-post', [PengaturanController::class, 'store'])->name('allownotifpost');
    });
