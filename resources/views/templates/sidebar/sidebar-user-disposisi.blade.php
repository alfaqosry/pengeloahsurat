<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ set_active(['arsip-disposisi.index']) }}"><a class="nav-link"
                    href="{{ route('arsip-disposisi.index') }}">
                    <i class="fa fa-history" aria-hidden="true"></i><span>Histori Disposisi</span></a>
            </li>

            <li class="{{ set_active(['arsip-approval.index']) }}"><a class="nav-link"
                    href="{{ route('arsip-approval.index') }}">
                    <i class="fa fa-history" aria-hidden="true"></i><span>Histori Approval</span></a>
            </li>

            <li class=""><a class="nav-link" href="{{ route('allownotif') }}">
                    <i class="fas fa-envelope-open-text"></i><span>Notifikasi</span></a>
            </li>
