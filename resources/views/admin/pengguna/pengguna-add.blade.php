                    ...
                    <div class="card shadow ">
                        ...
                        <div class="card-body">
                            <div class="card-title">
                                ...
                                <small class="text-info">*catatan: staff sub bagian tidak termasuk dalam kategori
                                    pengguna!</small>
                            </div>
                            <form action="{{ route('data-pengguna.store') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off" name="nip_pegawai" id="nip_pegawai"
                                        class="form-control search-input-admin @error('nip_pegawai') is-invalid @enderror"
                                        placeholder="Masukan NIP / Nama Pegawai" value="{{ old('nip_pegawai') }}">
                                    <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" autocomplete="off"
                                        ...
                                        name="email" placeholder="Masukan Email Pegawai" value="{{ old('email') }}">
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off" name="nowa" id="nowa"
                                        class="form-control  @error('nowa') is-invalid @enderror"
                                        placeholder="Masukan no Whatsapp" value="{{ old('nowa') }}">
                                ...
                                <a href="{{ route('data-pengguna.index') }}" class="btn btn-warning"><i
